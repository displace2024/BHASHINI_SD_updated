...
def get_args():
    ...
    parser.add_argument("segments") # emb_segments.list or llk_segments.list
    ...
    return args.emb_file,args.segments, args.rttm_path, args.mode
...
def main():
    emb_file,segments, rttm_path, mode = get_args()
    ...
    print(f"Clustering ({mode}) done!")
    print(f"RTTM file saved to {out_file}") 
