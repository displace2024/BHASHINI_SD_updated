...
def run(input_file, out_subsegments_folder, max_segment_duration, overlap_duration, max_remaining_duration, constant_duration):
    input_file = os.path.abspath(input_file)
    print("Input file:", input_file)
    print("Output subsegments folder:", out_subsegments_folder)

    if os.path.exists(input_file):
        print("Input file exists.")
        input_segment_file = input_file
        ...
        print("Subsegments file created:", output_subsegments_file)
    else:
